        ...
        <div className="steps2-container2 thq-grid-2">
          <div className="steps2-section-header">
            <h2 className="thq-heading-2">
              Get Started on Your Fishing Journey with Gear from our Shop
            </h2>
          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text25">Choose the Right Gear</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Select the appropriate fishing equipment based on your
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text31">Find the Perfect Spot</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Research and locate the best fishing spots near you with
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Learn and practice different fishing techniques to improve
                      your chances of a successful catch.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      Remember that fishing is also about enjoying nature and
                      the process, so stay patient and have fun!
                    </span>
                  </Fragment>
                )}
              </span>

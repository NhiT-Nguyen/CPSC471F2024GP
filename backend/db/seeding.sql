...
JoinDate		DATETIMETIME			NOT NULL,
PRIMARY KEY (MEmail),
UNIQUE (MUsername)
);
...
PRIMARY KEY (Locname, Locname,FishingType),
FOREIGN KEY (LocName) REFERENCES FISHING_LOCATION (Name)
);

CREATE TABLE FISHING_GEAR (
ItemID			INT	AUTO_INCREMENT	AUTO_INCREMENT	NOT NULL,
...
CREATE TABLE COMMENT (
  ...
  PostID INT NOT NULL,
  DateWritten DATETIMETIME NOT NULL,
  Title VARCHAR(20),
  Body TEXT NOT NULL,
  PRIMARY KEY (MemUsername, PostID, MemUsername, PostID, DateWritten),
...
Body			TEXT	NOT NULL,
Rating			INT			NOT NULL,
PRIMARY KEY (DateWritten,MemUsername,ItemID,MemUsername,ItemID),
FOREIGN KEY (ItemID) REFERENCES FISHING_GEAR (ItemID),
FOREIGN KEY (MemUsername) REFERENCES MEMBER (MUsername)
);
